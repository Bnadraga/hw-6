...
var _savedMessageJs = require("./saved-message.js");
...
btn.addEventListener("click", ()=>{
    const info = (0, _savedMessageJs.allInfo)();
    nameText.textContent = info.name;
    mailText.textContent = info.mail;
    messageText.textContent = info.message;
});

},{"./saved-message.js":"egHH5"}],"egHH5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "allInfo", ()=>allInfo);
function allInfo() {
